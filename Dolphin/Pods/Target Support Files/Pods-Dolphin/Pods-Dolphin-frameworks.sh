...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Dolphin/BEMCheckBox.framework"
  install_framework "Pods-Dolphin/BSKeyboardControls.framework"
  install_framework "Pods-Dolphin/Bolts.framework"
  install_framework "Pods-Dolphin/FBSDKCoreKit.framework"
  install_framework "Pods-Dolphin/FBSDKLoginKit.framework"
  install_framework "Pods-Dolphin/FBSDKMessengerShareKit.framework"
  install_framework "Pods-Dolphin/FBSDKShareKit.framework"
  ...
  install_framework "Pods-Dolphin/KeychainSwift.framework"
  install_framework "Pods-Dolphin/NSDate_TimeAgo.framework"
  install_framework "Pods-Dolphin/OAuthSwift.framework"
  install_framework "Pods-Dolphin/RSKImageCropper.framework"
